...
public class BlockGoldenPig extends BlockContainer {

	public BlockGoldenPig (int id) {
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		{
			icons[i] = par1IconRegister.registerIcon("collectibles" + ":pig_" + i);
		}
	}
