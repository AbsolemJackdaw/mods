...
public class TileEntitySpecialRendererGoldenPigs extends TileEntitySpecialRenderer{

	ModelPig ichun = new ModelPig();
	ResourceLocation LOC0 = new ResourceLocation("collectibles:textures/models/pig_0.png");
	ResourceLocation LOC1 = new ResourceLocation("collectibles:textures/models/pig_1.png");
	ResourceLocation LOC2 = new ResourceLocation("collectibles:textures/models/pig_2.png");
	ResourceLocation LOC3 = new ResourceLocation("collectibles:textures/models/pig_3.png");
	ResourceLocation LOC4 = new ResourceLocation("collectibles:textures/models/pig_4.png");
	ResourceLocation LOC5 = new ResourceLocation("collectibles:textures/models/pig_5.png");
	ResourceLocation LOC6 = new ResourceLocation("collectibles:textures/models/pig_6.png");

	ResourceLocation LOC02 = new ResourceLocation("collectibles:textures/models/pig_overlay_0.png");
	ResourceLocation LOC12 = new ResourceLocation("collectibles:textures/models/pig_overlay_1.png");
	ResourceLocation LOC22 = new ResourceLocation("collectibles:textures/models/pig_overlay_2.png");
	ResourceLocation LOC32 = new ResourceLocation("collectibles:textures/models/pig_overlay_3.png");
	ResourceLocation LOC42 = new ResourceLocation("collectibles:textures/models/pig_overlay_4.png");
	ResourceLocation LOC52 = new ResourceLocation("collectibles:textures/models/pig_overlay_5.png");
	ResourceLocation LOC62 = new ResourceLocation("collectibles:textures/models/pig_overlay_6.png");
	...
	public void renderTileEntityAt(TileEntity te, double d, double d1,
		...
		int meta = block != null ? block.getDamageValue(te.worldObj, te.xCoord, te.yCoord, te.zCoord) : 0 ;
		...
		switch(meta){
		case 0 :bindTexture(LOC02);	break;
		case 1 :bindTexture(LOC12);	break;
		case 2 :bindTexture(LOC22);	break;
		case 3 :bindTexture(LOC32);	break;
		case 4 :bindTexture(LOC42);	break;
		case 5 :bindTexture(LOC52);	break;
		case 6 :bindTexture(LOC62);	break;
		default : bindTexture(LOC02); break;
		}
		ichun.render(null, 0,0,0,0,0,0.0625f);
