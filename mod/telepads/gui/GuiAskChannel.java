...
public class GuiAskChannel extends GuiScreen{

	private GuiTextField textfield;
	public EntityPlayer thePlayer;
	public TETelepad te;

	public GuiAskChannel(EntityPlayer player, TETelepad te){
		thePlayer = player;
		this.te = te;
	}
	...
	public void initGui() {
		...
		String text = te.TELEPORTCHANNEL;
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		try{
			...
			fontRendererObj.drawSplitString("What Channel do you want to connect to ? : "+textfield.getText(), posX+1 -75, posY-1-20, 180 ,0x000000);
			fontRendererObj.drawSplitString("What Channel do you want to connect to ? : "+textfield.getText(), posX   -75, posY  -20, 180 ,0xff0000);
		}finally{
	...
	public void sendPacket(String channelName){
		...
		try {
			...
			out.writeInt(ServerPacketHandler.IDENTIFIER_ENTEREDCHANNEL);
