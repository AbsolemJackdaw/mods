...
public class SkeletonBuddy extends BuddyBase
{
	public SkeletonBuddy(World par1World)
	{
		super(par1World);		this.setMountedYOffset(3.2f);

	}
	public SkeletonBuddy(World par1World, EntityPlayer player)
	{
	 ...
	 */
	public SkeletonBuddy spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		return null;
	}
