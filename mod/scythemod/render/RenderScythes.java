...
public class RenderScythes extends Render
{
    private Item field_94151_a;
    private int field_94150_f;

    public RenderScythes(Item par1, int par2)
    {
        this.field_94151_a = par1;
        this.field_94150_f = par2;
    }

    public RenderScythes(Item par1)
    {
        this(par1, 0);
    }
    ...
    {
        Icon icon = this.field_94151_a.getIconFromDamage(0);
