...
//            return;
//        }
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture("/DSM/dragongui.png"));

        float dragonHealth = (float) dragon.getDragonHealth() / (float) dragon.getMaxHealth();
