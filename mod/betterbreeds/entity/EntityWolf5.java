...
import betterbreeds.entity.ai.EntityAIBeg5;
import betterbreeds.entity.ai.EntityAITamed3;
...
public class EntityWolf5 extends EntityTameable
{
	...
	public EntityWolf5(World par1World)
	{
		super(par1World);
		...
		this.tasks.addTask(8, new EntityAIBeg5(this, 8.0F));
		this.tasks.addTask(9, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
		this.tasks.addTask(9, new EntityAILookIdle(this));
		this.targetTasks.addTask(1, new EntityAIOwnerHurtByTarget(this));
		this.targetTasks.addTask(2, new EntityAIOwnerHurtTarget(this));
		this.targetTasks.addTask(3, new EntityAIHurtByTarget(this, true));
		this.targetTasks.addTask(3, new EntityAITamed3(this, EntityMob.class, 16.0F, 1, true));
		Name = "";
	}
	@Override
	...
	{
		return this.isTamed() ? "/subaraki/DeadDog.png" : (this.isAngry() ? "/mob/wolf_angry.png" : super.getTexture());
	}
	...
	public boolean interact(EntityPlayer par1EntityPlayer)
	{
		...
		if (this.isTamed())
		{
			...
			{ 
				...
				{   
					ModBreeds.proxy.openGUI(par1EntityPlayer,5,this.entityId);
	 ...
	 */
	 ...
	 public boolean canMateWith(EntityAnimal par1EntityAnimal)
	 {
		 ...
		 else if (!(par1EntityAnimal instanceof EntityWolf5))
		 {
			 return false;
		 }
		 else
		 {
			 EntityWolf5 var2 = (EntityWolf5)par1EntityAnimal;
