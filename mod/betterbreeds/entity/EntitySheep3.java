...
public class EntitySheep3 extends EntityAnimal
{
	/**
	...
	protected int getDropItemId()
	{
		...
		if(this.isBurning())
		{
			if (v == 0)
			{
				this.dropItem(ModBreeds.Sheepcooked.itemID, 1);
			}
			else if (v ==1)
			{
				this.dropItem(ModBreeds.Sheepcooked.itemID, 2);

			}
			else if (v ==2)
			{
				this.dropItem(ModBreeds.Sheepcooked.itemID, 3);
		...
		else
		{
			if (v ==0)
			{
				this.dropItem(ModBreeds.Sheepraw.itemID, 1);
			}
			else if (v ==1)
			{
				this.dropItem(ModBreeds.Sheepraw.itemID, 2);

			}
			else if (v ==2)
			{
				this.dropItem(ModBreeds.Sheepraw.itemID, 3);
	...
	public boolean interact(EntityPlayer par1EntityPlayer)
	{
		...
		{
			EntitySheep5 var21 = new EntitySheep5(this.worldObj);        	 var21.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch);
	 ...
	 */
	 ...
	 public EntityAnimal spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	 {
		 ...
		 if (k <= 30)
		 {
			 return new EntitySheep3(this.worldObj);

		 }
		 else if (k > 30 && k <=60)
		 {
			 return new EntitySheep2(this.worldObj);
		 ...
		 {
			 return new EntitySheep4(this.worldObj);
		 ...
		 if(k!=0)
		 {
			 ...
			 if(v < 50)
			 {
				 return new EntitySheep5 (this.worldObj);
			 }}
