...
{
	private static final ResourceLocation texture = new ResourceLocation("subaraki/cow2.png");
    ...
    public void renderCow(EntityCow2 par1EntityCow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderCow((EntityCow2)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderCow((EntityCow2)par1Entity, par2, par4, par6, par8, par9);
    }
}
