...
public class RenderPig2 extends RenderLiving
{
	...
	{
		return this.func_110919_a((EntityPig2)par1Entity);
	}
    ...
    public void func_77098_a(EntityPig2 par1EntityPig, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        return this.renderSaddledPig((EntityPig2)par1EntityLiving, par2, par3);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        this.func_77098_a((EntityPig2)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.func_77098_a((EntityPig2)par1Entity, par2, par4, par6, par8, par9);
    }
}
