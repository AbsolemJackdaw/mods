...
public class RenderChicken4 extends RenderLiving
{
	...
	{
		return this.func_110919_a((EntityChicken4)par1Entity);
	}


	public RenderChicken4(ModelBase par1ModelBase, float par2)
	{
		super(par1ModelBase, par2);
	}

	public void renderChicken(EntityChicken4 par1EntityChicken, double par2, double par4, double par6, float par8, float par9)
	{
		super.doRenderLiving(par1EntityChicken, par2, par4, par6, par8, par9);
	}

	protected float getWingRotation(EntityChicken4 par1EntityChicken, float par2)
	{
	...
	{
		return this.getWingRotation((EntityChicken4)par1EntityLiving, par2);
	}

	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderChicken((EntityChicken4)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.renderChicken((EntityChicken4)par1Entity, par2, par4, par6, par8, par9);
	}
}
