...
public class RenderWolf6 extends RenderLiving
{
	...
	{
		return this.getTailRotation((EntityWolf6)par1EntityLiving, par2);
	}

	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderWolf((EntityWolf6)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.renderWolf((EntityWolf6)par1Entity, par2, par4, par6, par8, par9);
	}
}
