...
public class RenderChicken2 extends RenderLiving
{
	...
	public void renderChicken(EntityChicken2 par1EntityChicken, double par2, double par4, double par6, float par8, float par9)
	{
		super.doRenderLiving(par1EntityChicken, par2, par4, par6, par8, par9);
	}

	protected float getWingRotation(EntityChicken2 par1EntityChicken, float par2)
	{
