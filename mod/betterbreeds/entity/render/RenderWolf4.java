...
public class RenderWolf4 extends RenderLiving
{
	...
	protected ResourceLocation func_110914_a(EntityWolf4 par1EntityWolf)
	{
	...
	public RenderWolf4(ModelBase par1ModelBase, float par2)
	{
		super(par1ModelBase, par2);
	}

	public void renderWolf(EntityWolf4 b, double par2, double par4, double par6, float par8, float par9)
	{
		super.doRenderLiving(b, par2, par4, par6, par8, par9);
	}

	protected float getTailRotation(EntityWolf4 par1EntityWolf, float par2)
	{
	...
	{
		return this.getTailRotation((EntityWolf4)par1EntityLiving, par2);
	}

	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderWolf((EntityWolf4)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.renderWolf((EntityWolf4)par1Entity, par2, par4, par6, par8, par9);
	}
}
