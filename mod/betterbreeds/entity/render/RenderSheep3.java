...
public class RenderSheep3 extends RenderLiving
{
    ...
    protected int setWoolColorAndRender(EntitySheep3 par1EntitySheep, int par2, float par3)
    {
        if (par2 == 0 && !par1EntitySheep.getSheared())
        {
        	this.bindTexture(new ResourceLocation("subaraki:BB/shortfur.png"));
            float var4 = 1.0F;
    ...
    public void doRenderSheep(EntitySheep3 par1EntitySheep, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        return this.setWoolColorAndRender((EntitySheep3)par1EntityLiving, par2, par3);
    }
    @Override
    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        this.doRenderSheep((EntitySheep3)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.doRenderSheep((EntitySheep3)par1Entity, par2, par4, par6, par8, par9);
    }
}
