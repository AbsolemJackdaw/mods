...
public class Paintings {
	...
	public void load(FMLInitializationEvent init){
		...
		if(!tiny && Insane && !sphax && !gib)
		{
			...
			EnumHelper.addArt("EnumArt","ins001",128,64,192,0);
			EnumHelper.addArt("EnumArt","ins002",48,48,320,0);
			EnumHelper.addArt("EnumArt","ins003",48,16,368,32);
			EnumHelper.addArt("EnumArt","ins004",32,48,416,0);
			EnumHelper.addArt("EnumArt","ins005",64,64,448,0);
			EnumHelper.addArt("EnumArt","ins006",256,48,64,128);
			EnumHelper.addArt("EnumArt","ins007",320,48,128,48);
			EnumHelper.addArt("EnumArt","ins008",320,112,48,16);
			EnumHelper.addArt("EnumArt","ins000",384,112,48,16);
			EnumHelper.addArt("EnumArt","ins010",64,448,48,96);
			EnumHelper.addArt("EnumArt","ins011",160,448,48,96);
			EnumHelper.addArt("EnumArt","ins012",320,128,128,128);
			EnumHelper.addArt("EnumArt","ins013",256,192,64,64);
			// tweede deel, onder origineel
			EnumHelper.addArt("EnumArt","ins014",0,256,48,16);
			EnumHelper.addArt("EnumArt","ins015",48,256,16,16);
			EnumHelper.addArt("EnumArt","ins016",64,256,16,32);
			EnumHelper.addArt("EnumArt","ins017",80,256,16,32);
			EnumHelper.addArt("EnumArt","ins018",96,256,16,32);
			EnumHelper.addArt("EnumArt","ins019",112,256,48,16);
			EnumHelper.addArt("EnumArt","ins020",112,272,48,16);
			EnumHelper.addArt("EnumArt","ins021",160,256,16,48);
			EnumHelper.addArt("EnumArt","ins022",172,256,16,48);
			EnumHelper.addArt("EnumArt","ins023",0,172,32,16);
			EnumHelper.addArt("EnumArt","ins024",32,172,32,16);
			EnumHelper.addArt("EnumArt","ins025",0,288,32,16);
			EnumHelper.addArt("EnumArt","ins026",32,288,32,16);
			EnumHelper.addArt("EnumArt","ins027",64,288,32,16);
			EnumHelper.addArt("EnumArt","ins028",96,288,32,16);
			EnumHelper.addArt("EnumArt","ins029",128,288,32,16);
			EnumHelper.addArt("EnumArt","ins030",0,304,64,16);
			EnumHelper.addArt("EnumArt","ins031",64,304,16,48);
			EnumHelper.addArt("EnumArt","ins032",80,304,32,48);
			EnumHelper.addArt("EnumArt","ins033",112,304,80,80);
			EnumHelper.addArt("EnumArt","ins034",0,320,16,32);
			EnumHelper.addArt("EnumArt","ins035",16,320,16,32);
			EnumHelper.addArt("EnumArt","ins036",32,320,16,32);
			EnumHelper.addArt("EnumArt","ins037",48,320,16,32);
			EnumHelper.addArt("EnumArt","ins038",64,320,16,32);
			EnumHelper.addArt("EnumArt","ins039",0,352,64,32);
			EnumHelper.addArt("EnumArt","ins040",64,352,48,32);
			EnumHelper.addArt("EnumArt","ins041",0,384,64,32);
			EnumHelper.addArt("EnumArt","ins042",64,384,64,32);
			EnumHelper.addArt("EnumArt","ins043",128,384,64,32);
			EnumHelper.addArt("EnumArt","ins044",0,412,32,32);
			EnumHelper.addArt("EnumArt","ins045",32,412,32,32);
			EnumHelper.addArt("EnumArt","ins046",64,412,32,32);
			EnumHelper.addArt("EnumArt","ins047",98,412,32,32);
			EnumHelper.addArt("EnumArt","ins048",128,412,32,32);
			EnumHelper.addArt("EnumArt","ins049",160,412,32,32);
			EnumHelper.addArt("EnumArt","ins050",0,448,64,64);
			EnumHelper.addArt("EnumArt","ins051",64,448,64,64);
			EnumHelper.addArt("EnumArt","ins052",128,448,64,64);
			EnumHelper.addArt("EnumArt","ins053",186,320,64,48);
			EnumHelper.addArt("EnumArt","ins054",186,364,64,48);
			EnumHelper.addArt("EnumArt","ins055",186,408,64,48);
			EnumHelper.addArt("EnumArt","ins056",186,462,64,48);
			EnumHelper.addArt("EnumArt","ins057",192,256,128,64);
			EnumHelper.addArt("EnumArt","ins058",256,320,64,128);
			EnumHelper.addArt("EnumArt","ins059",256,448,64,64);
			EnumHelper.addArt("EnumArt","ins060",320,256,64,64);
			EnumHelper.addArt("EnumArt","ins061",368,256,64,64);
			EnumHelper.addArt("EnumArt","ins062",416,256,32,48);
			EnumHelper.addArt("EnumArt","ins063",448,256,64,64);
			EnumHelper.addArt("EnumArt","ins064",448,320,64,80);
			EnumHelper.addArt("EnumArt","ins065",448,412,64,80);
			EnumHelper.addArt("EnumArt","ins066",320,304,128,64);
			EnumHelper.addArt("EnumArt","ins067",320,368,64,16);
			EnumHelper.addArt("EnumArt","ins068",320,384,128,16);
			EnumHelper.addArt("EnumArt","ins069",320,400,64,16);
			EnumHelper.addArt("EnumArt","ins070",320,412,128,96);
			EnumHelper.addArt("EnumArt","ins071",384,368,64,16);
			EnumHelper.addArt("EnumArt","ins072",384,400,64,16);
			//sphax
			EnumHelper.addArt("EnumArt","XtraImg001", 48, 16, 112, 0);
			EnumHelper.addArt("EnumArt","XtraImg002", 16, 48, 160, 0);
			EnumHelper.addArt("EnumArt","XtraImg003", 16, 48, 176, 0);
