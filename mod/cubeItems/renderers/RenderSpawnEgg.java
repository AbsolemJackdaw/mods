...
public class RenderSpawnEgg extends RenderCubeInterface{
	...
	ModelCubeWorld egg_base = new ModelCubeWorld(ModelCubeWorld.class.getResourceAsStream("/assets/subaraki/cubeModels/egg_base.cub"));
	ModelCubeWorld egg_overlay = new ModelCubeWorld(ModelCubeWorld.class.getResourceAsStream("/assets/subaraki/cubeModels/egg_overlay.cub"));
	...
	public void postSpecials(ItemStack item, ModelCubeWorld model, Object... data) {
		...
		int color2 = ((ItemMonsterPlacer)item.getItem()).getColorFromItemStack(item,1);
