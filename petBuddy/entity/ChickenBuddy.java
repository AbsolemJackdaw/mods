...
public class ChickenBuddy extends BuddyBase
{
	public ChickenBuddy(World par1World)
	{
		super(par1World);		this.setMountedYOffset(3.2f);

	}
	public ChickenBuddy(World par1World, EntityPlayer player)
	{
	 ...
	 */
	public ChickenBuddy spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		return null;
	}
