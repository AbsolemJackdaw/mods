...
public class EntityAIBeg6 extends EntityAIBase
{
    private EntityWolf6 theWolf;
    private EntityPlayer field_75385_b;
    private World worldObject;
    private float minPlayerDistance;
    private int field_75384_e;

    public EntityAIBeg6(EntityWolf6 entityWolf6, float par2)
    {
        this.theWolf = entityWolf6;
        this.worldObject = entityWolf6.worldObj;
