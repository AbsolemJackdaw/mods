...
{
    private EntityWolf2 theWolf;
    private EntityPlayer thePlayer;
    private World worldObject;
    private float minPlayerDistance;
    private int field_75384_e;

    public EntityAIBeg2(EntityWolf2 par1EntityWolf2, float par2)
    {
        this.theWolf = par1EntityWolf2;
        this.worldObject = par1EntityWolf2.worldObj;
