...
public class EntitySheep2 extends EntityAnimal
{
    /**
    ...
    public EntitySheep2(World par1World)
    {
        super(par1World);
        this.texture = "/subaraki/milksheep.png";
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.itemID == Item.bucketEmpty.itemID)
        {
            if (--var2.stackSize <= 0)
            {
                par1EntityPlayer.inventory.setInventorySlotContents(par1EntityPlayer.inventory.currentItem, new ItemStack(ModBreeds.Sheepmilk));
            }
            else if (!par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModBreeds.Sheepmilk)))
            {
