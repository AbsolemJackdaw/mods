...
public class EntityPig3 extends EntityAnimal
{
	public EntityPig3(World par1World)
	{
		super(par1World);
		this.texture = "/subaraki/pig3.png";
	...
	protected int getDropItemId()
	{
		...
		if (this.isBurning())
		{
			if (j == 0)
			{
				this.dropItem(Item.porkCooked.itemID, 4);

			}
			else	if (j > 0 && j <= 5)
			{
				this.dropItem(Item.porkCooked.itemID, 3);
			}
		}
		else
		{
