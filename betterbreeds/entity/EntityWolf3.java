...
import betterbreeds.entity.ai.EntityAIBeg3;
...
public class EntityWolf3 extends EntityTameable
{
	...
	public EntityWolf3(World par1World)
	{
		super(par1World);
		...
		this.tasks.addTask(8, new EntityAIBeg3(this, 8.0F));
	...
	{
		return this.isTamed() ? "/subaraki/BlackWolf.png" : (this.isAngry() ? "/mob/wolf_angry.png" : super.getTexture());
	}
	...
	public EntityAnimal spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		...
		if (k >= 3 && k < 8)
		{
			EntityWolf3 var2 = new EntityWolf3(this.worldObj);
			var2.setOwner(this.getOwnerName());
			var2.setTamed(true);
			return var2;
		}
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof EntityWolf3))
		{
			return false;
		}
		else
		{
			EntityWolf3 var2 = (EntityWolf3)par1EntityAnimal;
