...
public class DragonEntity extends FlyingTameableEntity {
    ...
    public DragonEntity(World world) {
        ...
        moveSpeed = 0.3f;
        moveSpeedAir = 1;
        jumpMovementFactor = landMovementFactor;
        ...
        if (isClient()) {
            ...
            targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntitySheep.class, 16, 200, false)); // mutex 1
            targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntityPig.class, 16, 200, false)); // mutex 1
            targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntityChicken.class, 16, 200, false)); // mutex 1
        }
    }
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (isTamed() || isChild()) {
            ...
            if (getDragonHealth() != getMaxHealth()) {
...
//                        aiSit.setSitting(true);
     ...
     */
    @Override
    public boolean attackEntityFrom(DamageSource src, int par2) {
    ...
    public float getEyeHeight() {
        ...
        float healthMulti = getDragonHealth() / (float) getMaxHealth();
    ...
    public String getTexture() {
    	  return isZombie() ? "/DSM/Zdragon.png":"/DSM/Hdragon.png";     }
