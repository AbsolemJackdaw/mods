...
import scythemod.dragon.ModelPartProxy;
...
public class DragonModel extends ModelBase {
    ...
    public static final int VERTS_NECK = 6;
...
//        tailScaleMiddle.showModel = false;
     ...
     */
    @Override
    public void setLivingAnimations(EntityLiving entity, float moveTime, float moveSpeed, float partialTicks) {
        setLivingAnimations((DragonEntity) entity, moveTime, moveSpeed, partialTicks);
    }
    
    public void setLivingAnimations(DragonEntity dragon, float moveTime, float moveSpeed, float partialTicks) {
    ...
    public void render(Entity entity, float moveTime, float moveSpeed, float ticksExisted, float lookYaw, float lookPitch, float scale) {
        render((DragonEntity) entity, moveTime, moveSpeed, ticksExisted, lookYaw, lookPitch, scale);
    }
    
    public void render(DragonEntity dragon, float moveTime, float moveSpeed, float ticksExisted, float lookYaw, float lookPitch, float scale) {
        DragonAnimator animator = dragon.getAnimator();
     ...
     */
    public void renderModel(DragonEntity dragon, float scale) {
        GL11.glPushMatrix();
