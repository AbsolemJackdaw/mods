...
public class EntityCReaper extends EntityMob
{
    /**
    ...
    public EntityCReaper(World par1World)
    {
        super(par1World);
        this.texture = "/DSM/Greaper.png";
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new EntityAICReaperSwell(this));
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityLiving.class, 6.0F, 0.25F, 0.3F));
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        if (par1DamageSource.getEntity() instanceof EntityCreeper)
        {
        	int var2 = Item.ingotGold.itemID;
            this.dropItem(var2, 1);
        }
    }
